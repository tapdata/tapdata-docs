...
- Supports deployment of Tapdata on [Windows platform](quick-start/install/install-on-windows.md), further expanding the range of supported deployment platforms.
...
- In the data platform mode, it can directly [display the relationship of table-level traceability](user-guide/real-time-data-hub/daas-mode/dashboard#release320-daas), helping you to visually show the link relationship of data tables.
